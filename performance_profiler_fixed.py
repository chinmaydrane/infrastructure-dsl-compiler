#!/usr/bin/env python3
"""
Performance Profiler for DSL Compiler - ASCII Version
...
class PerformanceProfiler:
    ...
    def profile_all_files(self, input_directory: str = "input") -> List[Dict]:
        """Profile all DSL files in input directory"""
        dsl_files = []
        ...
        for file_path in sorted(dsl_files):
            ...
            if 'error' in result:
                ...
                print(f"  [OK] {result['filename']}: {result['compilation_time_ms']:.1f}ms, "
